//
//  YookaNewNewsfeedViewController.h
//  Yooka
//
...
@interface YookaNewNewsfeedViewController : UIViewController<UITableViewDataSource,UIAlertViewDelegate,UITableViewDelegate,UITabBarControllerDelegate,UIScrollViewDelegate>{
    int i;
    int j;
    int k;
    int l;
