...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.25f];
            CGFloat arc = [self valueForOption:iCarouselOptionArc withDefault:M_PI/2];
            ...
            CGFloat angle = [self valueForOption:iCarouselOptionAngle withDefault:offset / count * arc]/2;
        ...
        {
            CGFloat count = [self circularCarouselItemCount];
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:0.75f];
            CGFloat arc = [self valueForOption:iCarouselOptionArc withDefault:M_PI/2];
            CGFloat radius = [self valueForOption:iCarouselOptionRadius withDefault:_itemWidth * spacing * count ];
