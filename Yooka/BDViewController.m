...
//                    NSLog(@"likes = %@",self_.postLikes);
                    ...
                    if (!(self_.postLikers == (id)[NSNull null])) {
                        if ([self_.postLikers containsObject:self_.userEmail]) {
                    ...
                    if ([self_.likeStatus isEqualToString:@"YES"]) {
                        ...
                        if (self_.postLikers == (id)[NSNull null]) {
                            ...
                            self_.postLikers = [NSMutableArray arrayWithObject:myEmail];
                            ...
                            [self_.postLikers addObject:myEmail];
                            //                        [_likersData replaceObjectAtIndex:view.tag withObject:_postLikers];
...
//            }
//            [self.yookaImages addObject:image];
//            k++;
//            [self loadImages];
//            
//            //        NSLog(@"profile image");
